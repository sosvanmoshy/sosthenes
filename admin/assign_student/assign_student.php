				...
				<tr>
					...
					<td><div class="amount">
						...
						<?php  
							...
							echo "VERIFIED USERS ARE"."<br><br>".$output;
						?>
					</div></td>
					...
					<table border="0">
						...
						<tr>
							<td colspan="10" width="100%">
								...
								echo '<a href=../student/addstudentform.php><button class="addbtn">ADD NEW USER [+] </button></a>';
							...
							<?php  
								...
								if ($display > 0) {
									while ($rows = mysqli_fetch_assoc($result)) {
										echo "<tr><td>".$rows['fname']."</td><td>".$rows['mname']."</td><td>".$rows['lname']."</td><td>".$rows['faculty']."</td><td>".$rows['dob']."</td><td>".$rows['address']."</td><td>".$rows['Phone_number']."</td><td>".$rows['email']."</td><td>".$rows['user_group']."</td><td>"."<a href='../delete_update_user/deletecode.php?email=".$rows['email']."'>DELETE</a>"."<a href='#'><button class='deltbtn'>UPDATE DATA</button></a>"."</td></tr>";
									}
								}
