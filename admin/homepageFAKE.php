...
.amount {
	...
	box-shadow: -8px -8px 8px white,8px 8px 8px black;
	width: 80%;
	height: 90px;
}
	...
	<nav class="nav2">
		...
		<div>
			<table border="0">
				<tr>
					<td><br>
							<div class="profile"><center><div class="amount">
						<br>
						<?php  
						...
						<table height="400px">
							...
							<tr>
								<td class="tdTEXTS">
									...
									echo '<a href="../report.php""><img src="'.$image.'" class="a"></a>';
					...
					<table border="0">
						...
						<tr>
							<td colspan="10" width="100%">
								...
								//echo '<a href=student/addstudentform.php><input type = "submit" value="ADD NEW STUDENT"></a>';
